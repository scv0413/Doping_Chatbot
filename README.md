...
## Operation and Extension Plans

- `app/chat/docs/staging-smoke-readiness-plan.md` - readiness와 staging smoke 검증 계획
- `app/chat/docs/agent-mcp-extension-plan.md` - Agent/MCP tool 확장 설계
...
- full tests: 121 passed, 1 LangSmith dependency warning
- ruff: pass
- Docker build/run smoke: pass
- public API: query-only
- debug API: internal options allowed
- Docker non-root user: appuser

## Next Steps

1. deeper readiness 설계/구현
2. staging smoke script
3. API auth/rate limit
4. Agent tool / MCP wrapper 설계

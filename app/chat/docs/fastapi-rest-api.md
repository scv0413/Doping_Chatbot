...
Request body는 `app.chat.runtime.ChatRequest`, response body는 `app.chat.runtime.ChatResponse`를 그대로 사용한다.
...
- `uv run pytest`: 86 passed, 1 LangSmith dependency warning
